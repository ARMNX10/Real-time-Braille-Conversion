...
if not cap.isOpened():
    ...
    if ret:
        ...
        # Perform OCR on the captured image with additional parameters
        custom_config = r'--oem 3 --psm 7'
        extracted_text = pytesseract.image_to_string(image_path, config=custom_config, output_type=Output.STRING)
