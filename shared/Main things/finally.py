...
# Load the content from "Output2.txt"
with open("Output2.txt", "r") as input_file:
    content = input_file.read()

# Define a function to filter meaningful words from text
...
# Filter meaningful words from the content of "Output2.txt"
filtered_meaningful_response = filter_meaningful_words(content)

# Write the filtered response to "Output3.txt"
with open("Output3.txt", "w") as output_file3:
    output_file3.write(filtered_meaningful_response)
